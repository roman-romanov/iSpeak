...
class NatureWidget extends StatefulWidget {
  const NatureWidget({Key? key}) : super(key: key);

  @override
  _NatureWidgetState createState() => _NatureWidgetState();
}

class _NatureWidgetState extends State<NatureWidget> {
  Widget _pauseButton =
